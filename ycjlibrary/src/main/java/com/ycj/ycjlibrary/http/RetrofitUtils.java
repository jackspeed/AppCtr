    ...
    private void initOkHttpClient(Context context) {
        if (null == mOkHttpClient) {
            ...
            mOkHttpClient = new OkHttpClient.Builder()
                    ...
                    .addInterceptor(loggingInterceptor)//添加网络请求URL日志输出拦截器
                    .addInterceptor(mTokenInterceptor)//添加Token拦截器
                    .addNetworkInterceptor(TestInterceptor)//添加网络连接器
        ...
        public Response intercept(Chain chain) throws IOException {
            ...
            if (!StringUtils.isEmpty(token)) {
                authorised = chain.request()
                        ...
                        .addHeader("clientAgent", "Android|" + Build.VERSION.RELEASE + "|" + Build.MODEL)
                        .addHeader("clientVersion", "Android|" + AppUtils.getAppVersionName(mContext))
