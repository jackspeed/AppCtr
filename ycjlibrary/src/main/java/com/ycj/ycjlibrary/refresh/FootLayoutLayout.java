...
public class FootLayoutLayout extends FrameLayout {
	...
	public FootLayoutLayout(Context context, final int mode, boolean showUpdateTime, String releaseLabel, String pullLabel, String refreshingLabel) {
		super(context);
		...
		switch (mode) {
			case PullToRefreshView.MODE_PULL_UP_TO_LOAD_MORE:
	...
	public void releaseToRefresh() {
		...
		if(time > 0){
			headerTime.setText(getResources().getString(R.string.pull_to_refresh_last_time) + new Date().toLocaleString());
		}
	}
